...
function main() {
	document.getElementById("theme-switch").addEventListener("click", function () {
		...
		themeImg.setAttribute("src", themeImg.getAttribute("src") === "./images/sun.svg" ? "./images/moon.svg" : "./images/sun.svg");
	});
...
function addTodo(todos = JSON.parse(localStorage.getItem("todos"))) {
	...
	todos.forEach(function (todo) {
		...
		cbContainer.classList.add("ab-container");
		cbInput.classList.add("ab-input");
		...
		button.addEventListener("click", function () {
			...
			correspondingCard.classList.add("del-anime");
